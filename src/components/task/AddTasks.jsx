    ...
    <div className="flex justify-center items-center py-6 md:py-12 bg-gray-900 min-h-screen">
      <div className="bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Submit Button */}
          <button
            className={`bg-white text-gray-900 px-6 py-3 rounded-md w-full ${isLoading ? 'opacity-50' : 'hover:bg-gray-300'} focus:outline-none focus:ring-2 focus:ring-gray-500 transition duration-300 font-semibold`}
            disabled={isLoading}
          >
